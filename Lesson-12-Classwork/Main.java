class Main {
  ...
  String getCounsoler(String official){
    if(official.substring(0,1).equals("D") || 
       official.substring(1,2).equals("D")){
      return  "Dinn";
    }
    else if(official.substring(0,1).equals("F") || 
       official.substring(1,2).equals("F")){
      return  "Flores";
    }
    else if(official.substring(0,1).equals("C") || 
       official.substring(1,2).equals("C")){
      return  "Chu";
    }
    else if(official.substring(0,1).equals("G") || 
       official.substring(1,2).equals("G")){
      return  "Gibson";
    }
    else if(official.substring(0,1).equals("E") || 
       official.substring(1,2).equals("E")){
      return  "Eyzengart";
    }
    else if(official.substring(0,1).equals("B") || 
       official.substring(1,2).equals("B")){
      return  "Berrouet";
    }
    else
      return "Unknown";
